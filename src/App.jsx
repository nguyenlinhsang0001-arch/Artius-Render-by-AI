...
const APP_VERSION = "v36.5 · 21/06/2026";
    ...
    >
      <div className="w-full max-w-[1536px] md:max-w-none mx-auto px-4 md:px-6 h-14 md:h-16 flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 md:gap-3 shrink-0">
          ...
          <div className="hidden md:flex items-center gap-3" style={{ transform: "scale(0.7)", transformOrigin: "right center" }}>
            {/* pill counts */}
            ...
            {/* IMAGE — lên trên cùng khu Kết quả, dính theo cuộn (sticky) */}
                ...
                {platform === "nanobanana" && prompts?.nanobanana && modelImg && (!isDesktop || genImg || genStatus === "generating" || genStatus === "error") && (
                  <div className="mt-3 rounded-2xl p-4 ipa-img-sticky md:ipa-result-panel" style={{ background: C.panel, border: `1px solid ${C.line}` }}>
                    ...
                    {genStatus === "generating" && (
                      <div className="rounded-xl flex items-center justify-center md:ipa-gen-fill" style={{ aspectRatio: "16 / 10", background: C.inputBg, border: `1px dashed ${C.lineSoft}`, color: C.textDim }}>
