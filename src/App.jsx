...
const APP_VERSION = "v28.12 · 10/06/2026";
                        ...
                        >
                          ...
                          {STYLE_IMAGES[p.id] && (
                            <span
                              ...
                              className="absolute bottom-0.5 right-0.5 z-20 inline-flex items-center justify-center w-6 h-6 rounded-full cursor-pointer transition-opacity duration-150 opacity-100 md:opacity-50 md:group-hover:opacity-100 hover:scale-110"
