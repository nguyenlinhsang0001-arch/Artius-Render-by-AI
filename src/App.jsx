...
const APP_VERSION = "v34.4 · 19/06/2026";
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-4">
              ...
              <div className="flex-1 rounded-2xl p-4" style={{ background: C.panel, border: `1px solid ${C.line}` }}>
                ...
                <p className="text-xs mb-3" style={{ color: C.textDim }}>
                  Chọn Nội thất hay Kiến trúc để Agent dùng đúng bộ neo khóa hình &amp; thuật ngữ phân tích.
                </p>
          ...
          <div className={(activeTab === "result" ? "" : "hidden ") + "ipa-col-right"}>
            ...
            {prompts && (
              <div className="ipa-anim">
                ...
                <div className="hidden md:flex items-stretch gap-2 mt-5 pt-4" style={{ borderTop: `1px solid ${C.line}` }}>
                  <div className="flex-1 rounded-xl px-3 py-2.5 text-[12.5px] leading-snug max-h-24 overflow-y-auto ipa-scroll" style={{ background: C.inputBg, border: `1px solid ${C.line}`, color: prompts?.nanobanana ? C.text : C.textFaint, fontFamily: MONO, whiteSpace: "pre-wrap" }}>
                    {prompts?.nanobanana || "Prompt sẽ được Agent tạo tự động sau khi phân tích…"}
                  </div>
                  <button
                    type="button"
                    onClick={renderImage}
