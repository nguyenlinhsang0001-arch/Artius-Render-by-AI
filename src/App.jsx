...
const APP_VERSION = "v32.10 · 14/06/2026";
                  ...
                  {STYLE_INTENSITY_LEVELS.map((lv) => {
                    ...
                    return (
                      <button key={lv.value} onClick={() => changeStyleIntensity(lv.value)} className="text-center transition-all" aria-pressed={on}>
                        <div className="rounded-lg overflow-hidden" style={{ border: `3px solid ${on ? C.accent : "transparent"}`, aspectRatio: "1 / 1", boxShadow: on ? "0 0 12px rgba(122,162,196,0.55)" : "none" }}>
