...
const APP_VERSION = "v35.1 · 19/06/2026";
              ...
              <div className="hidden md:flex flex-col items-center justify-center text-center py-4 px-4 ipa-anim">
                {modelImg ? (
                  <>
                    ...
                    <p className="text-sm mt-4" style={{ color: C.textDim }}>Ảnh MODEL đã sẵn sàng — bấm <span style={{ color: C.accentSoft, fontWeight: 600 }}>“Phân tích &amp; Tạo prompt”</span> để bắt đầu.</p>
                  </>
                ) : (
                  <>
