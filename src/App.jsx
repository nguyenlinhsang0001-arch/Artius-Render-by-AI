...
const APP_VERSION = "v34.8 · 19/06/2026";
...
<body>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <div className="flex items-center gap-3 rounded-xl" style={{ background: C.inputBg, border: `1px solid ${C.line}`, padding: "7px 15px" }}>
              <div className="flex items-center gap-1.5">
                ...
                <span style={{ fontSize: 11, fontWeight: 700, color: C.text, fontFamily: MONO, lineHeight: 1 }}>{counts.prompts.toLocaleString()}</span>
              </div>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span style={{ fontSize: 11, fontWeight: 700, color: C.text, fontFamily: MONO, lineHeight: 1 }}>{counts.images.toLocaleString()}</span>
              </div>
            </div>
  ...
  const navRailEl = (
    <nav
      className="hidden md:flex flex-col items-center gap-2 pt-2 pb-4 shrink-0"
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: `radial-gradient(140% 90% at 50% -10%, ${C.bgGrad} 0%, ${C.bgDeep} 60%)`, color: C.text, fontFamily: FONT, overflowX: "clip" }}>
      ...
      <div className="w-full max-w-[1536px] md:max-w-none mx-auto px-4 md:px-6 pt-4 md:pt-2 pb-4 md:pb-6">
        ...
        <div className="py-2 mb-2">
          ...
          <div className={(activeTab === "result" ? "" : "hidden ") + "ipa-col-right"}>
              ...
              <div className="flex items-center gap-1.5 text-[11px]" style={{ color: C.textDim, fontFamily: MONO }}>
                ...
                {modelImg?.w && modelImg?.h ? (
                  <button
                    ...
                    title="Kích thước ảnh MODEL — bấm để áp tỷ lệ khung gợi ý"
                    className="rounded-md px-2 py-1 inline-flex items-center gap-1 transition-colors"
                    style={{ background: C.inputBg, border: `1px solid ${C.accent}66`, color: C.accentSoft, cursor: "pointer" }}
                  >
                    {modelImg.w}×{modelImg.h}
                    <span style={{ color: C.textFaint }}>→</span>
                    <span style={{ color: C.accent, fontWeight: 700 }}>{suggestAspectRatio(modelImg.w, modelImg.h)}</span>
                  </button>
                ) : null}
              </div>
            </div>
            ...
            {!prompts && !genImg && !progressActive && (
              <div className="hidden md:flex flex-col items-center justify-center text-center py-16 px-6 ipa-anim">
                {modelImg ? (
                  <>
                    <img src={`data:${modelImg.mediaType};base64,${modelImg.data}`} alt="Ảnh MODEL" draggable={false} onContextMenu={(e) => e.preventDefault()} className="max-h-[56vh] max-w-full rounded-2xl select-none" style={{ border: `1px solid ${C.line}`, WebkitTouchCallout: "none", pointerEvents: "none" }} />
