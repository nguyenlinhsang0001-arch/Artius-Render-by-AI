...
const APP_VERSION = "v34.0 · 19/06/2026";
...
<body>
  ...
  const navRailEl = (
    <nav
      className="hidden md:flex flex-col items-center gap-1.5 py-4 shrink-0"
    ...
    >
      {navRailItems.map(({ Icon, label }, i) => (
        <button
          ...
          style={{
            color: i === 0 ? C.accent : C.railIcon,
            background: i === 0 ? `${C.accent}1a` : "transparent",
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: `radial-gradient(140% 90% at 50% -10%, ${C.bgGrad} 0%, ${C.bgDeep} 60%)`, color: C.text, fontFamily: FONT, overflowX: "clip" }}>
      ...
      <div className="w-full max-w-[1536px] mx-auto px-4 md:px-6 py-4 md:py-6">
