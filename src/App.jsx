...
const APP_VERSION = "v33.2 · 17/06/2026";
      ...
      >
        ...
        >
          <div className="flex flex-col items-center text-center mb-6">
            <img src={ARTIUS_LOGO} alt="ARTIUS" className="h-16 w-auto mb-10" style={{ opacity: 0.95 }} />
            <h1 className="text-xl font-extrabold tracking-tight" style={{ color: C.accent }}>Interior Render Agent</h1>
            <p className="text-xs mt-1.5" style={{ color: C.textDim }}>Công cụ nội bộ ARTIUS</p>
          </div>
