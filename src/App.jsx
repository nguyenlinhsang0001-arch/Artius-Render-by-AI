...
const APP_VERSION = "v23.1 · 08/06/2026";
  ...
  async function renderImage() {
    ...
    try {
      const response = await fetch(IMAGE_API_URL, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ model: "gpt-image-2", prompt, images, size: "auto" }),
      });
                ...
                {platform === "nanobanana" && prompts.nanobanana && modelImg && (
                  <div className="mt-3 rounded-2xl p-4" style={{ background: C.panel, border: `1px solid ${C.line}` }}>
                    ...
                    {genImg && genStatus !== "generating" && (
                      <div>
                        <img src={genImg} alt="Kết quả gpt-image-2" className="w-full rounded-xl" style={{ border: `1px solid ${C.line}` }} />
