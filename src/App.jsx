...
const APP_VERSION = "v36.1 · 21/06/2026";
      ...
      <style>{`
        ...
        *:focus-visible { outline: 2px solid ${C.accent}; outline-offset: 2px; }
        ...
        @media (min-width: 768px) {
          ...
          /* Ảnh kết quả: luôn vừa khung viewport desktop, không phải cuộn (B5) */
          .ipa-result-frame { width: fit-content; max-width: 100%; margin-left: auto; margin-right: auto; }
          .ipa-result-frame > img:first-of-type { max-height: calc(100dvh - 360px); max-width: 100%; width: auto !important; height: auto; object-fit: contain; }
        }
      `}</style>
