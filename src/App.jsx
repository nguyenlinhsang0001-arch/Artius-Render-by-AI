...
const APP_VERSION = "v36.8 · 21/06/2026";
          ...
          <div className={(activeTab === "result" ? "" : "hidden ") + "ipa-col-right"}>
            ...
            {/* IMAGE — lên trên cùng khu Kết quả, dính theo cuộn (sticky) */}
                ...
                {platform === "nanobanana" && prompts?.nanobanana && modelImg && (!isDesktop || genImg || genStatus === "generating" || genStatus === "error") && (
                  <div className="mt-3 rounded-2xl p-4 ipa-img-sticky ipa-result-panel" style={{ background: C.panel, border: `1px solid ${C.line}` }}>
                    {!isDesktop && (
                    <div className="flex items-center justify-between mb-2.5 gap-2 flex-wrap">
                      <div>
                    ...
                    {genImg && genStatus !== "generating" && (
                      <div className="ipa-result-body">
                        ...
                        <div
                          ...
                          style={{ border: `1px solid ${C.line}`, background: C.bg, touchAction: "none", cursor: "pointer", WebkitTouchCallout: "none", WebkitUserSelect: "none", userSelect: "none" }}
