...
const GEOMETRY_LEVELS = [
  ...
  { value: 3, label: "Lấy cảm hứng",   short: "Mở",   desc: "Bám góc máy model (xê dịch nhẹ); mở nhất = mức 2 + biến hình vỏ kiến trúc, tỷ lệ, chiều cao trần, khối.",
...
const APP_VERSION = "v29.1 · 12/06/2026";
