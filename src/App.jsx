...
const APP_VERSION = "v28.11 · 10/06/2026";
                        ...
                        >
                          ...
                          {STYLE_IMAGES[p.id] && (
                            <span
                              ...
                              className="absolute bottom-1 right-1 z-20 inline-flex items-center justify-center w-7 h-7 rounded-full cursor-pointer transition-opacity duration-150 opacity-100 md:opacity-0 md:group-hover:opacity-100 hover:scale-110"
        ...
        >
          <div className="relative w-full max-w-3xl" onClick={(e) => e.stopPropagation()}>
            <img
              ...
              style={{ maxHeight: "82vh", objectFit: "contain", border: `1px solid ${C.line}` }}
            />
            ...
            <button
              ...
              onClick={() => setZoomStyle(null)}
              aria-label="Đóng"
              className="absolute -top-3 -right-3 inline-flex items-center justify-center w-9 h-9 rounded-full shadow-lg transition-transform hover:scale-110"
              style={{ background: C.accent, color: C.onAccent }}
            >
              <X className="w-5 h-5" />
            </button>
