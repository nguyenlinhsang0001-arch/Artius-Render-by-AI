...
const APP_VERSION = "v35.0 · 19/06/2026";
      ...
      <div className="w-full max-w-[1536px] md:max-w-none mx-auto px-4 md:px-6 h-14 md:h-16 flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 md:gap-3 shrink-0">
          ...
          <div className="hidden md:flex items-center gap-3">
            {/* pill counts */}
            <div className="flex items-center gap-3 rounded-xl" style={{ background: C.inputBg, border: `1px solid ${C.line}`, padding: "11px 15px" }}>
