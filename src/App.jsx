...
const APP_VERSION = "v36.2 · 21/06/2026";
      ...
      <style>{`
        ...
        *:focus-visible { outline: 2px solid ${C.accent}; outline-offset: 2px; }
        ...
        @media (min-width: 768px) {
          ...
          .ipa-grid {
            display: grid; grid-template-columns: 396px minmax(0, 1fr); gap: 1.25rem;
          ...
          .ipa-result-frame  { flex: 0 1 auto; min-height: 0; width: fit-content; max-width: 100%; margin-left: auto; margin-right: auto; }
          .ipa-result-frame > img:first-of-type { display: block; min-height: 0; max-height: 100%; max-width: 100%; width: auto !important; height: auto; object-fit: contain; }
